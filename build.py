...
#import SocketServer
import socketserver
####neeraj change starts added for tkinter
...
def createstack(**kwargs):
	...
	# #####neeraj change starts added by neeraj for capturing picture######
	# root = Tk()
	# filename =	 filedialog.askopenfilenames(initialdir = "/",title = "Select file",filetypes = (("jpeg files","*.jpg"),("all files","*.*")))
	# print (filename[0])
	# ##neeraj change ends
	# ######neeraj change starts here for putting neeraj image in S3
	# print("putting neeraj image in s3...")
	# #Initialize clients
	# s3_client = boto3.client('s3')
	# s3_bucket = "rekognitionframe05jan2019"
	# s3_key_frames_root = "neeraj/"
	# frame_id = "neerajne-eraj-neer-ajne-erajneerajne"
	# year = "2019"
	# mon = "01"
	# day = "13"
	# hour = "01"
	# s3_key_comp = (s3_key_frames_root + '{}/{}/{}/{}/{}.jpg').format(year, mon, day, hour, frame_id)
	# imageFile='neeraj.jpg'
	# print(" calling s3 s3_client.put_object method to put neeraj image into s3 bucket")
	# with open(imageFile, 'rb') as image:
		# s3_client.put_object(
			...
			# Body=image.read()
		# )
	# print('putting neeraj image into s3 completes...')
	# ####neeraj change ends
...
@task()
def webuiserver(webdir="web-ui/",port=8081):
